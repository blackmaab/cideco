...
(function () {
     ...
     */
    HBI.widget.Carousel = function (el, cfg) {

        HBI.widget.Carousel.superclass.constructor.call(this, el, cfg);
    };
    ...
    var Carousel    = HBI.widget.Carousel,
        Dom         = HBI.util.Dom,
   ...
   /**
    ...
    function getStyle(el, style, type) {
        ...
        function getStyleIntVal(el, style) {
             ...
             */
            if (style == "marginRight" && HBI.env.ua.webkit) {
    ...
    HBI.extend(Carousel, HBI.util.Element, {
        ...
        updatePagination: function () {
            ...
            pagination.el.innerHTML = JS.isFunction(cb.fn) ? cb.fn.apply(scope, [pagination.template, replacements]) : HBI.lang.substitute(pagination.template, replacements);
        },
        ...
        _animateAndSetCarouselOffset: function (offset, item, sentinel) {
            ...
            if (carousel.get("isVertical")) {
                animObj = new HBI.util.Motion(carousel._carouselEl,
                        { top: { to: offset } },
        ...
        _validateAnimation: function (cfg) {
            ...
            if (JS.isObject(cfg)) {
                ...
                } else if (!JS.isUndefined(HBI.util.Easing)) {
                    cfg.effect = HBI.util.Easing.easeOut;
                }
            } else {
                rv = false;
            }
...
;;  End: **
*/
HBI.register("carousel", HBI.widget.Carousel, {version: "2.8.0r4", build: "2449"});
