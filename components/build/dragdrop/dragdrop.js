...
HBI.util.DragDropMgr = function() {
    ...
    return {
        /**
        * This property is used to turn on global use of the shim element on all DragDrop instances, defaults to false for backcompat. (Use: HBI.util.DDM.useShim = true)
        * @property useShim
        * @type Boolean
        * @static
        */
        ...
        */
        _shimState: false,
        /**
        * This property is used when useShim is set to true, it will set the opacity on the shim to .5 for debugging. Use: (HBI.util.DDM._debugShim = true;)
        * @private
        * @property _debugShim
        * @type Boolean
        * @static
        ...
        */
        ...
        handleMouseDown: function(e, oDD) {
            ...
            this.currentTarget = HBI.util.Event.getTarget(e);
            ...
            this.startX = HBI.util.Event.getPageX(e);
            this.startY = HBI.util.Event.getPageY(e);
        ...
        stopEvent: function(e) {
            if (this.stopPropagation) {
                HBI.util.Event.stopPropagation(e);
            }

            if (this.preventDefault) {
                HBI.util.Event.preventDefault(e);
            }
        },
        ...
        handleMouseMove: function(e) {
            ...
            if (dc) {
                ...
                if (HBI.util.Event.isIE && !e.button) {
                    this.stopEvent(e);
                ...
                if (!this.dragThreshMet) {
                    var diffX = Math.abs(this.startX - HBI.util.Event.getPageX(e));
                    var diffY = Math.abs(this.startY - HBI.util.Event.getPageY(e));
        ...
        fireEvents: function(e, isDrop) {
            ...
            var x = HBI.util.Event.getPageX(e),
                y = HBI.util.Event.getPageY(e),
                pt = new HBI.util.Point(x,y),
                pos = dc.getTargetCoord(pt.x, pt.y),
                el = dc.getDragEl(),
                events = ['out', 'over', 'drop', 'enter'],
                curRegion = new HBI.util.Region( pos.y, 
         ...
         * usage is:
         * <code>
         * HBI.util.DragDropMgr.refreshCache(ddinstance.groups);
         * </code>
         * Alternatively:
         * <code>
         * HBI.util.DragDropMgr.refreshCache({group1:true, group2:true});
         * </code>
         ...
         *                       location for
         * @return {HBI.util.Region} a Region object representing the total area
        ...
        getLocation: function(oDD) {
            ...
            return new HBI.util.Region( t, r, b, l );
        },

        /**
         * Checks the cursor location to see if it over the target
         * @method isOverTarget
         * @param {HBI.util.Point} pt The point to evaluate
         * @param {DragDrop} oTarget the DragDrop object we are inspecting
         * @param {boolean} intersect true if we are in intersect mode
         * @param {HBI.util.Region} pre-cached location of the dragged element
         ...
         * @return {HBI.util.DDM.ElementWrapper} the wrapped element
         * @private
        ...
        getElWrapper: function(id) {
            ...
            if (!oWrapper || !oWrapper.el) {
                oWrapper = this.elementCache[id] = 
                    new this.ElementWrapper(HBI.util.Dom.get(id));
            }
            return oWrapper;
        },
         ...
         * @deprecated use HBI.util.Dom.get instead
         * @static
         */
        getElement: function(id) {
            return HBI.util.Dom.get(id);
        },
         ...
         * @deprecated use HBI.util.Dom instead
         * @static
         */
        getCss: function(id) {
            var el = HBI.util.Dom.get(id);
         ...
         * @for DragDropMgr
         * @deprecated use HBI.util.Dom.getX instead
         * @static
         */
        getPosX: function(el) {
            return HBI.util.Dom.getX(el);
        },
         ...
         * @deprecated use HBI.util.Dom.getY instead
         * @static
         */
        getPosY: function(el) {
            return HBI.util.Dom.getY(el); 
        },
         ...
         * @deprecated use HBI.util.Dom.getStyle
         * @static
         */
        getStyle: function(el, styleProp) {
            return HBI.util.Dom.getStyle(el, styleProp);
        },
        ...
        moveToEl: function (moveEl, targetEl) {
            var aCoord = HBI.util.Dom.getXY(targetEl);
            HBI.util.Dom.setXY(moveEl, aCoord);
        },
         ...
         * @deprecated use HBI.util.Dom.getViewportHeight instead
         * @static
         */
        getClientHeight: function() {
            return HBI.util.Dom.getViewportHeight();
        },
         ...
         * @deprecated use HBI.util.Dom.getViewportWidth instead
         * @static
         */
        getClientWidth: function() {
            return HBI.util.Dom.getViewportWidth();
        },
...
HBI.util.DDM = HBI.util.DragDropMgr;
HBI.util.DDM._addListeners();
 ...
 * element itself as in {@link HBI.util.DD}.  setDragElId() lets you define
 * a separate element that would be moved, as in {@link HBI.util.DDProxy}
 * </li>
 * </ul>
 ...
 * <pre>
 *  dd = new HBI.util.DragDrop("div1", "group1");
 * </pre>
 ...
 */
HBI.util.DragDrop = function(id, sGroup, config) {
    if (id) {
        this.init(id, sGroup, config); 
    }
};

HBI.util.DragDrop.prototype = {
    /**
    ...
    /**
    * @method on
    * @description Shortcut for EventProvider.subscribe, see <a href="HBI.util.EventProvider.html#subscribe">HBI.util.EventProvider.subscribe</a>
    */
    on: function() {
     ...
     * element. An example of this can be found in HBI.util.DDProxy
     * @method getDragEl
     * @return {HTMLElement} the html element 
     */
    getDragEl: function() {
     ...
     * @method handleMouseDown
     * @param {Event} e 
     * @param {HBI.util.DragDrop} oDD the clicked dd object (this dd obj)
     * @private
     */
    handleMouseDown: function(e, oDD) {
        ...
        var pt = new HBI.util.Point(Event.getPageX(e), Event.getPageY(e));
    ...
    clickValidator: function(e) {
        var target = HBI.util.Event.getTarget(e);
...
HBI.augment(HBI.util.DragDrop, HBI.util.EventProvider);

/**
* @event mouseDownEvent
* @description Provides access to the mousedown event. The mousedown does not always result in a drag operation.
* @type HBI.util.CustomEvent See <a href="HBI.util.Element.html#addListener">Element.addListener</a> for more information on listening for this event.
*/
 ...
 *                    scroll
 */
HBI.util.DD = function(id, sGroup, config) {
    if (id) {
        this.init(id, sGroup, config);
    }
};

HBI.extend(HBI.util.DD, HBI.util.DragDrop, {
     ...
     * to the center of the object, as done in HBI.widget.Slider)
     * @method setDelta
    ...
    alignElWithMouse: function(el, iPageX, iPageY) {
        ...
        if (!this.deltaSetXY) {
            ...
            HBI.util.Dom.setXY(el, aCoord);

            var newLeft = parseInt( HBI.util.Dom.getStyle(el, "left"), 10 );
            var newTop  = parseInt( HBI.util.Dom.getStyle(el, "top" ), 10 );

            this.deltaSetXY = [ newLeft - oCoord.x, newTop - oCoord.y ];
        } else {
            HBI.util.Dom.setStyle(el, "left", (oCoord.x + this.deltaSetXY[0]) + "px");
            HBI.util.Dom.setStyle(el, "top",  (oCoord.y + this.deltaSetXY[1]) + "px");
        }
    ...
    cachePosition: function(iPageX, iPageY) {
        if (iPageX) {
            ...
            var aCoord = HBI.util.Dom.getXY(this.getEl());
     ...
     * HBI.util.DragDrop, but all versions of this method through the 
     * inheritance chain are called
     */
    applyConfig: function() {
        HBI.util.DD.superclass.applyConfig.call(this);
    ...
    b4MouseDown: function(e) {
        this.setStartPosition();
        // this.resetConstraints();
        this.autoOffset(HBI.util.Event.getPageX(e), 
                            HBI.util.Event.getPageY(e));
    },
     ...
     */
    b4Drag: function(e) {
        this.setDragElPos(HBI.util.Event.getPageX(e), 
                            HBI.util.Event.getPageY(e));
    },
 ...
 */
HBI.util.DDProxy = function(id, sGroup, config) {
    if (id) {
        this.init(id, sGroup, config);
        this.initFrame(); 
    }
 ...
 * @property HBI.util.DDProxy.dragElId
 * @type String
 * @static
 */
HBI.util.DDProxy.dragElId = "ygddfdiv";

HBI.extend(HBI.util.DDProxy, HBI.util.DD, {
     ...
     * we use the cursor offset provided by HBI.util.DD.  Another option that works only if
    ...
    createFrame: function() {
        ...
        var div=this.getDragEl(), Dom=HBI.util.Dom;
    ...
    applyConfig: function() {
        HBI.util.DDProxy.superclass.applyConfig.call(this);

        this.resizeFrame = (this.config.resizeFrame !== false);
        this.centerFrame = (this.config.centerFrame);
        this.setDragElId(this.config.dragElId || HBI.util.DDProxy.dragElId);
    },
    ...
    showFrame: function(iPageX, iPageY) {
        ...
        HBI.util.Dom.setStyle(dragEl, "visibility", "visible"); 
    },
    ...
    // overrides HBI.util.DragDrop
    b4MouseDown: function(e) {
        this.setStartPosition();
        var x = HBI.util.Event.getPageX(e);
        var y = HBI.util.Event.getPageY(e);
        this.autoOffset(x, y);
    ...
    // overrides HBI.util.DragDrop
    b4EndDrag: function(e) {
        HBI.util.Dom.setStyle(this.getDragEl(), "visibility", "hidden"); 
    },

    // overrides HBI.util.DragDrop
    // By default we try to move the element to the last location of the frame.  
    // This is so that the default behavior mirrors that of HBI.util.DD.  
    endDrag: function(e) {
        var DOM = HBI.util.Dom;
        var lel = this.getEl();
 ...
 *                    none
 */
HBI.util.DDTarget = function(id, sGroup, config) {
    if (id) {
        this.initTarget(id, sGroup, config);
    }
};

// HBI.util.DDTarget.prototype = new HBI.util.DragDrop();
HBI.extend(HBI.util.DDTarget, HBI.util.DragDrop, {
    toString: function() {
        return ("DDTarget " + this.id);
    }
});
HBI.register("dragdrop", HBI.util.DragDropMgr, {version: "2.8.0r4", build: "2449"});
