...
(function () {
    ...
    * @static
    */
    HBI.widget.MenuManager = function () {
        ...
        * passed back by the event utility (HBI.util.Event).
        */
                ...
                for (var i in m_oVisibleMenus) {
                    ...
                    if (Lang.hasOwnProperty(m_oVisibleMenus, i)) {
                        ...
                        if (oMenu.cfg.getProperty(_CLICK_TO_HIDE) && 
                            !(oMenu instanceof HBI.widget.MenuBar) && 
        ...
        * was fired.
        * @param {HBI.widget.Menu} p_oMenu The menu that fired the event.
        */
        ...
        */
        function onItemAdded(p_sType, p_aArgs) {
            ...
            if (oItem instanceof HBI.widget.MenuItem) { 
        ...
        return {
            ...
            * @param {HBI.widget.Menu} p_oMenu Object specifying the Menu  
            ...
            */
            addMenu: function (p_oMenu) {
                ...
                if (p_oMenu instanceof HBI.widget.Menu && p_oMenu.id && 
                    !m_oMenus[p_oMenu.id]) {
            ...
            * (excluding instances of HBI.widget.MenuBar).
            */
            hideVisible: function () {
                ...
                for (var i in m_oVisibleMenus) {
                    ...
                    if (Lang.hasOwnProperty(m_oVisibleMenus, i)) {
                        ...
                        if (!(oMenu instanceof HBI.widget.MenuBar) && 
                            oMenu.cfg.getProperty(_POSITION) == _DYNAMIC) {
...
*/
HBI.widget.Menu = function (p_oElement, p_oConfig) {
    ...
    HBI.widget.Menu.superclass.constructor.call(this, p_oElement, p_oConfig);
...
var Dom = HBI.util.Dom,
    ...
    Menu = HBI.widget.Menu,
    MenuManager = HBI.widget.MenuManager,
...
* @default HBI.widget.MenuItem
* @final
* @type HBI.widget.MenuItem
*/
ITEM_TYPE: null,
...
* handlers used for hiding the menu via a call to "HBI.lang.later" have 
...
init: function (p_oElement, p_oConfig) {
    ...
    if (!this.ITEM_TYPE) {
        ...
        this.ITEM_TYPE = HBI.widget.MenuItem;
...
* item belongs.
* @param {HBI.widget.MenuItem} p_oItem Object reference for the MenuItem 
...
_execHideDelay: function () {
	...
	oRoot._hideDelayTimer = Lang.later(oRoot.cfg.getProperty(_HIDE_DELAY), this, function () {
        ...
        if (oRoot == this && !(this instanceof HBI.widget.MenuBar) && 
...
* @private
* @param {HBI.widget.Menu} p_oSubmenu Object specifying the submenu that  
* should be hidden.
			...
			if (!oItem.handledMouseOutEvent && ((oRelatedTarget != oItem.element &&  
				...
				if (!bMovingToSubmenu) {
					...
					if (oSubmenu) {
						...
						if (!(this instanceof HBI.widget.MenuBar) && nSubmenuHideDelay > 0 && 
...
* back by the event utility (HBI.util.Event).
* @param {HBI.widget.Menu} p_oMenu Object representing the menu that 
* fired the event.
*/
...
_onClick: function (p_sType, p_aArgs) {
	...
	var hide = function () {
		...
		if (oRoot instanceof HBI.widget.MenuBar || 
			...
			if (sURL) {
				...
				if (nHashPos != -1) {
					...
					if (nLen > 1) {
						...
						oMenu = HBI.widget.MenuManager.getMenu(sId);
        ...
        switch(oEvent.keyCode) {
            ...
            case 37:    // Left arrow
                ...
                if (oParentItem) {
                    ...
                    if (oParentMenu instanceof HBI.widget.MenuBar) {
	...
	*/
	...
	if (y < topConstraint || y  > bottomConstraint) {
		...
		if (bCanConstrain) {
			...
			else if (!(oMenu instanceof HBI.widget.MenuBar) && 
...
_onShow: function (p_sType, p_aArgs) {
    ...
    if (oParent) {
        ...
        if (!oParentMenu.cfg.getProperty(_AUTO_SUBMENU_DISPLAY) && 
            (oParentMenu instanceof HBI.widget.MenuBar || 
...
* was fired.
* @param {Array} p_aArgs Array of arguments sent when the event was fired.
* @param {HBI.widget.Menu} p_oSubmenu Object representing the submenu that 
...
_onParentMenuConfigChange: function (p_sType, p_aArgs, p_oSubmenu) {
    ...
    switch(sPropertyName) {
        ...
        case _SUBMENU_ALIGNMENT:
			...
			if (!(this.parent.parent instanceof HBI.widget.MenuBar)) {
...
* that was fired.
* @param {Array} p_aArgs Array of arguments sent when the event was fired.
* @param {HBI.widget.MenuItem} p_oItem Object representing the menu item 
...
* @param {Array} p_aArgs Collection of arguments sent when the event 
* was fired.
* @param {HBI.widget.Menu} p_oMenu The Menu instance fired
* the event.
*/
...
* @param {HBI.widget.Menu} p_oMenu The Menu instance fired the event.
*/
...
* @param {HBI.widget.MenuItem} p_oObject Object reference for the MenuItem 
...
removeItem: function (p_oObject, p_nGroupIndex) {
    ...
    if (!Lang.isUndefined(p_oObject)) {
        ...
        if (p_oObject instanceof HBI.widget.MenuItem) {
...
initDefaultConfig: function () {
    ...
    */
    ...
    /*
        ...
        property (inherited by HBI.widget.Overlay) to "true" by re-adding the property.
    */
...
* @constructor
*/
HBI.widget.MenuItem = function (p_oObject, p_oConfig) {
...
MenuItem.prototype = {
    ...
    */
    init: function (p_oObject, p_oConfig) {
        ...
        this.cfg = new HBI.util.Config(this);
    ...
    */
	_createKeyListener: function (type, args, keyData) {
		...
		var oKeyListener = new HBI.util.KeyListener(
	...
	*/
	initDefaultConfig : function () {
        ...
        * [<a href="HBI.widget.Menu.html#itemData">array of values for 
    ...
    */
	getNextSibling: function () {
		...
		return HBI.widget.MenuManager.getMenuItem(next.id);
    ...
    */
    hasFocus: function () {
        ...
        return (HBI.widget.MenuManager.getFocusedMenuItem() == this);
...
Lang.augmentProto(MenuItem, HBI.util.EventProvider);
...
* @class ContextMenu
* @constructor
* @extends HBI.widget.Menu
* @namespace HBI.widget
*/
HBI.widget.ContextMenu = function(p_oElement, p_oConfig) {

    HBI.widget.ContextMenu.superclass.constructor.call(this, p_oElement, p_oConfig);
...
var Event = HBI.util.Event,
	UA = HBI.env.ua,
    ContextMenu = HBI.widget.ContextMenu,
...
HBI.lang.extend(ContextMenu, HBI.widget.Menu, {
...
init: function(p_oElement, p_oConfig) {
    ...
    // Call the init of the superclass (HBI.widget.Menu)
...
initEvents: function() {
    ...
    this.triggerContextMenuEvent.signature = HBI.util.CustomEvent.LIST;
...
* by the event utility (HBI.util.Event).
* @param {HBI.widget.ContextMenu} p_oMenu Object representing the context 
    ...
    if (!(p_oEvent.type == _MOUSEDOWN && !p_oEvent.ctrlKey)) {
		...
		if (!this._bCancelled) {
			...
			*/
			...
			HBI.widget.MenuManager.hideVisible();
			...
			if (!HBI.util.Dom.inDocument(this.element)) {
...
* @constructor
* @extends HBI.widget.MenuItem
* @deprecated As of version 2.4.0 items for HBI.widget.ContextMenu instances
* are of type HBI.widget.MenuItem.
*/
HBI.widget.ContextMenuItem = HBI.widget.MenuItem;
(function () {
...
* @namespace HBI.widget
*/
HBI.widget.MenuBar = function(p_oElement, p_oConfig) {

    HBI.widget.MenuBar.superclass.constructor.call(this, p_oElement, p_oConfig);
...
Lang.extend(MenuBar, HBI.widget.Menu, {
...
init: function(p_oElement, p_oConfig) {
    ...
    if(!this.ITEM_TYPE) {
        ...
        this.ITEM_TYPE = HBI.widget.MenuBarItem;
...
* was fired.
* @param {Array} p_aArgs Array of arguments sent when the event was fired.
* @param {HBI.widget.MenuBar} p_oMenuBar Object representing the menu bar 
* that fired the event.
*/
...
_onClick: function(p_sType, p_aArgs, p_oMenuBar) {
    ...
    if(oItem && !oItem.cfg.getProperty(_DISABLED)) {
        ...
        if(oSubmenu) {
			...
			nMenuItemX = HBI.util.Dom.getX(oItemEl);
...
* @extends HBI.widget.MenuItem
*/
HBI.widget.MenuBarItem = function(p_oObject, p_oConfig) {

    HBI.widget.MenuBarItem.superclass.constructor.call(this, p_oObject, p_oConfig);

};

HBI.lang.extend(HBI.widget.MenuBarItem, HBI.widget.MenuItem, {
...
init: function(p_oObject, p_oConfig) {
    ...
    if(!this.SUBMENU_TYPE) {
        ...
        this.SUBMENU_TYPE = HBI.widget.Menu;

    }


    /* 
        Call the init of the superclass (HBI.widget.MenuItem)
        Note: We don't pass the user config in here yet 
        because we only want it executed once, at the lowest 
        subclass level.
    */ 

    HBI.widget.MenuBarItem.superclass.init.call(this, p_oObject);  
...
HBI.register("menu", HBI.widget.Menu, {version: "2.8.0r4", build: "2449"});
