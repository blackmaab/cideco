...
HBI.util.Attribute = function(hash, owner) {
    if (owner) { 
        this.owner = owner;
...
HBI.util.Attribute.prototype = {
     ...
     * @property owner
     * @type HBI.util.AttributeProvider
     */
    owner: null,
...
(function() {
    var Lang = HBI.util.Lang;

    /*
    Copyright (c) 2006, HBI! Inc. All rights reserved.
    Code licensed under the BSD License:
    http://developer.HBI.net/yui/license.txt
    */
    
    /**
     * Provides and manages HBI.util.Attribute instances
     * @namespace HBI.util
     * @class AttributeProvider
     * @uses HBI.util.EventProvider
     */
    HBI.util.AttributeProvider = function() {};

    HBI.util.AttributeProvider.prototype = {
        ...
        subscribe: function(type, callback) {
            ...
            HBI.util.EventProvider.prototype.subscribe.apply(this, arguments);
        },
        ...
        createAttribute: function(map) {
            return new HBI.util.Attribute(map, this);
        }
    };
    
    HBI.augment(HBI.util.AttributeProvider, HBI.util.EventProvider);
})();

(function() {
// internal shorthand
var Dom = HBI.util.Dom,
    AttributeProvider = HBI.util.AttributeProvider,
	specialTypes = {
		mouseenter: true,
		mouseleave: true
	};
 ...
 * event listeners, using dom methods, and managing attributes. 
 * @class Element
 * @uses HBI.util.AttributeProvider
 * @constructor
...
Element.prototype = {
     ...
     * @method appendChild
     * @param {HBI.util.Element || HTMLElement} child The element to append. 
    ...
    addListener: function(type, fn, obj, scope) {
        ...
        return HBI.util.EventProvider.prototype.subscribe.apply(this, arguments); // notify via customEvent
    },
    ...
    get: function(key) {
        ...
        if (el && !configs[key] && !HBI.lang.isUndefined(el.value[key]) ) {
    ...
    set: function(key, value, silent) {
        ...
        if ( !this._configs[key] && !HBI.lang.isUndefined(el[key]) ) {
            this._setHTMLAttrConfig(key);
        }
    ...
    destroy: function() {
        var el = this.get('element');
        HBI.util.Event.purgeElement(el, true); // purge DOM listeners recursively
    ...
    _initElement: function(el, attr) {
        ...
        HBI.util.Event.onAvailable(attr.element, function() {
        ...
        HBI.util.Event.onContentReady(attr.element, function() {
            if (!isReady) { // otherwise already done
                this._initContent(attr);
            }
     ...
     * @param {HBI.util.Element} element The Element instance to
    ...
    _setHTMLAttrConfig: function(key, map) {
        ...
        this._configs[key] = new HBI.util.Attribute(map, this);
    }
};
...
HBI.augment(Element, AttributeProvider);
HBI.util.Element = Element;
})();

HBI.register("element", HBI.util.Element, {version: "2.8.0r4", build: "2449"});
