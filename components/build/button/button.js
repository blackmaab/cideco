...
(function () {
    ...
    var Dom = HBI.util.Dom,
        ...
        m_oOverlayManager = null,   // HBI.widget.OverlayManager instance
    ...
    */
    ...
    HBI.widget.Button = function (p_oElement, p_oAttributes) {
    
		if (!Overlay && HBI.widget.Overlay) {
        ...
        var fnSuperClass = HBI.widget.Button.superclass.constructor,
            oConfig,
            oElement;
    ...
    HBI.extend(HBI.widget.Button, HBI.util.Element, {
        ...
        * @default null
        * @protected
        * @type {<a href="HBI.widget.Overlay.html">HBI.widget.Overlay</a>|
        * <a href="HBI.widget.Menu.html">HBI.widget.Menu</a>}
        */
        _menu: null,
        ...
        _setMenu: function (p_oMenu) {
            ...
            var bLazyLoad = this.get("lazyloadmenu"),
                ...
                /*
                    ...
                    of HBI.widget.Menu or HBI.widget.Overlay.
                */
				...
				if (oMenu) {
					...
					if (Menu && oMenu instanceof Menu) {
						...
						if (!m_oOverlayManager) {
							...
							m_oOverlayManager = new HBI.widget.OverlayManager();
        ...
        */
        _addListenersToForm: function () {
            ...
            var oForm = this.getForm(),
                onFormKeyPress = HBI.widget.Button.onFormKeyPress,
        ...
        * @protected
        * @param {Event} p_oEvent Object representing the DOM event object 
        * passed back by the event utility (HBI.util.Event) that triggered 
        * the display of the menu.
        */
        _showMenu: function (p_oEvent) {

            if (HBI.widget.MenuManager) {
			...
			/*
				 ...
				 HBI.widget.MenuManager.hideVisible() resulted in another element in the 
        ...
        * object passed back by the event utility (HBI.util.Event).
        */
        ...
        */
        init: function (p_oElement, p_oAttributes) {
            ...
            HBI.widget.Button.superclass.init.call(this, p_oElement, p_oAttributes);
        ...
        */
        initAttributes: function (p_oAttributes) {
            ...
            HBI.widget.Button.superclass.initAttributes.call(this, 
                oAttributes);
            ...
            * <ul>
            * <li>Object specifying a rendered <a href="HBI.widget.Menu.html">
            * HBI.widget.Menu</a> instance.</li>
            * <li>Object specifying a rendered <a href="HBI.widget.Overlay.html">
            * HBI.widget.Overlay</a> instance.</li>
            ...
            * <a href="HBI.widget.Overlay.html">HBI.widget.Overlay</a>.  
            * If the <a href="HBI.widget.Menu.html#CSS_CLASS_NAME">
            * default CSS class name for HBI.widget.Menu</a> is applied to 
            * the <code>&#60;div&#62;</code> element, it will be created as an
            * instance of <a href="HBI.widget.Menu.html">HBI.widget.Menu
            ...
            * <a href="HBI.widget.MenuItem.html">HBI.widget.MenuItem</a> 
            * configuration attributes.</li>
            * <li>Array of strings representing the text labels for each menu 
            * item in the menu.</li>
            * </ul>
            * @type <a href="HBI.widget.Menu.html">HBI.widget.Menu</a>|<a 
            * href="HBI.widget.Overlay.html">HBI.widget.Overlay</a>|<a 
            ...
            * <a href="HBI.widget.Menu.html#lazyLoad">"lazyload"</a>
            ...
            * <a href="HBI.widget.Menu.html">HBI.widget.Menu</a> or 
            * <a href="HBI.widget.Overlay.html">HBI.widget.Overlay</a> 
            * instance is passed as the value of the button's "menu" 
            * configuration attribute. <a href="HBI.widget.Menu.html">
            * HBI.widget.Menu</a> or <a href="HBI.widget.Overlay.html">
            * HBI.widget.Overlay</a> instances should be rendered before 
        ...
        * @return {<a href="HBI.widget.Overlay.html">
        * HBI.widget.Overlay</a>|<a 
        * href="HBI.widget.Menu.html">HBI.widget.Menu</a>}
        */
        getMenu: function () {
        ...
        */
        destroy: function () {
            ...
            if (Lang.isArray(aButtons) && aButtons.length === 0) {
                ...
                Event.removeListener(oForm, "keypress", 
                        HBI.widget.Button.onFormKeyPress);
        ...
        fireEvent: function (p_sType , p_aArgs) {
			...
			return HBI.widget.Button.superclass.fireEvent.apply(this, arguments);
    ...
    */
    ...
    /**
    * @method HBI.widget.Button.addHiddenFieldsToForm
    * @description Searches the specified form and adds hidden fields for  
    * instances of HBI.widget.Button that are of type "radio," "checkbox," 
    * "menu," and "split."
    * @param {<a href="http://www.w3.org/TR/2000/WD-DOM-Level-1-20000929/level-
    * one-html.html#ID-40002357">HTMLFormElement</a>} p_oForm Object reference 
    * for the form to search.
    */
    HBI.widget.Button.addHiddenFieldsToForm = function (p_oForm) {
    
        var proto = HBI.widget.Button.prototype,
    ...
    /**
    * @method HBI.widget.Button.getButton
    ...
    * @return {HBI.widget.Button}
    */
    HBI.widget.Button.getButton = function (p_sId) {
    ...
    * the event utility (HBI.util.Event) when the event was fired.  See 
    * <a href="HBI.util.Element.html#addListener">Element.addListener</a> 
    ...
    * the event utility (HBI.util.Event) when the event was fired.  See 
    * <a href="HBI.util.Element.html#addListener">Element.addListener</a> for  
...
(function () {
    ...
    * @class ButtonGroup
    * @constructor
    * @extends HBI.util.Element
    */
    HBI.widget.ButtonGroup = function (p_oElement, p_oAttributes) {
    
        var fnSuperClass = HBI.widget.ButtonGroup.superclass.constructor,
            sNodeName,
            oElement,
            sId;
    ...
    HBI.extend(HBI.widget.ButtonGroup, HBI.util.Element, {
        ...
        * @protected
        * @param {Event} p_oEvent Object representing the event that was fired.
        * @param {<a href="HBI.widget.Button.html">HBI.widget.Button</a>}  
        ...
        */
        init: function (p_oElement, p_oAttributes) {
            ...
            HBI.widget.ButtonGroup.superclass.init.call(this, p_oElement, 
                    p_oAttributes);
        
            this.addClass(this.CLASS_NAME_PREFIX + this.CSS_CLASS_NAME);

        
            var sClass = (HBI.widget.Button.prototype.CLASS_NAME_PREFIX + "radio-button"),
        ...
        */
        initAttributes: function (p_oAttributes) {
            ...
            HBI.widget.ButtonGroup.superclass.initAttributes.call(
                this, oAttributes);
            ...
            * is checked.
            * @type {<a href="HBI.widget.Button.html">HBI.widget.Button</a>}
            * @default null
            */
        ...
        * @param {<a href="HBI.widget.Button.html">HBI.widget.Button</a>}  
        * p_oButton Object reference for the <a href="HBI.widget.Button.html">
        * HBI.widget.Button</a> instance to be added to the button group.
        ...
        * <a href="HBI.widget.Button.html">HBI.widget.Button</a> 
        * configuration attributes used to configure the button to be added to 
        * the button group.
        * @return {<a href="HBI.widget.Button.html">HBI.widget.Button</a>} 
        */
        ...
        * @param {Array} p_aButtons Array of <a href="HBI.widget.Button.html">
        * HBI.widget.Button</a> instances to be added 
        * to the button group.
        ...
        * a set of <a href="HBI.widget.Button.html">HBI.widget.Button</a>  
...
HBI.register("button", HBI.widget.Button, {version: "2.8.0r4", build: "2449"});
