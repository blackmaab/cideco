...
(function() {
     ...
     * @module tabview
     * @requires HBI, dom, event, element
     *
     */
    ...
    TabView = function(el, attr) {
        attr = attr || {};
        if (arguments.length == 1 && !HBI.lang.isString(el) && !el.nodeName) {
    ...
    HBI.extend(TabView, Y.Element, {
         ...
         * @method addTab
         * @param {HBI.widget.Tab} tab A Tab instance to add.
         ...
         * @method getTabIndex
         * @param {HBI.widget.Tab} tab The tab whose index will be returned.
         * @return int
         */
         ...
         * @method removeTab
         * @param {HBI.widget.Tab} item The Tab instance to be removed.
         * @return void
         */
        ...
        initAttributes: function(attr) {
            ...
            for (var type in this.DOM_EVENTS) {
                if ( HBI.lang.hasOwnProperty(this.DOM_EVENTS, type) ) {
        ...
        _initTabs: function() {
            ...
            for (var i = 0, len = tabs.length; i < len; ++i) {
                ...
                tab = new HBI.widget.Tab(tabs[i], attr);
                this.addTab(tab);
...
(function() {
    ...
    HBI.extend(Tab, HBI.util.Element, {
        /**
...
HBI.register("tabview", HBI.widget.TabView, {version: "2.8.0r4", build: "2449"});
