...
(function () {
    ...
    */
    HBI.util.Config = function (owner) {
    ...
    var Lang = HBI.lang,
        CustomEvent = HBI.util.CustomEvent,
        Config = HBI.util.Config;


    /**
     * Constant representing the CustomEvent type for the config changed event.
     * @property HBI.util.Config.CONFIG_CHANGED_EVENT
     * @private
     * @static
     * @final
     */
     ...
     * @property HBI.util.Config.BOOLEAN_TYPE
     * @private
     * @static
     * @final
     */
    ...
    * @method HBI.util.Config.alreadySubscribed
    * @static
    * @param {HBI.util.CustomEvent} evt The CustomEvent for which to check 
    * the subscriptions
    ...
    */
    ...
    HBI.lang.augmentProto(Config, HBI.util.EventProvider);
...
(function () {
    ...
    */
    HBI.widget.Module = function (el, userConfig) {
        if (el) {
    ...
    var Dom = HBI.util.Dom,
        Config = HBI.util.Config,
        Event = HBI.util.Event,
        CustomEvent = HBI.util.CustomEvent,
        Module = HBI.widget.Module,
        UA = HBI.env.ua,
    ...
    * @property HBI.widget.Module.IMG_ROOT
    * @static
    * @final
    * @type String
    */
    ...
    * @property HBI.widget.Module.IMG_ROOT_SSL
    * @static
    * @final
    * @type String
    */
    ...
    * @property HBI.widget.Module.CSS_MODULE
    * @static
    * @final
    * @type String
    */
    ...
    * @property HBI.widget.Module.CSS_HEADER
    * @static
    * @final
    * @type String
    */
    ...
    * @property HBI.widget.Module.CSS_BODY
    * @static
    * @final
    * @type String
    */
    ...
    * @property HBI.widget.Module.CSS_FOOTER
    * @static
    * @final
    * @type String
    */
    ...
    * @property HBI.widget.Module.RESIZE_MONITOR_SECURE_URL
    * @static
    * @final
    * @type String
    */
    ...
    * 
    * @property HBI.widget.Module.RESIZE_MONITOR_BUFFER
    * @static
    * @type Number
    */
    ...
    * size detection.
    * @event HBI.widget.Module.textResizeEvent
    */
     ...
     *
     * @method HBI.widget.Module.forceDocumentRedraw
     * @static
     */
    Module.forceDocumentRedraw = function() {
        ...
        if (docEl) {
            docEl.className += " ";
            docEl.className = HBI.lang.trim(docEl.className);
        }
    };
                ...
                if (!oIFrame) {
                    ...
                    if (!supportsCWResize) {
                        ...
                        sHTML = ["<html><head><script ",
                                 ...
                                 "HBI.widget.Module.textResizeEvent.",
                                 "fire();};<",
                                 "\/script></head>",
                                 "<body></body></html>"].join('');
    ...
    HBI.lang.augmentProto(Module, HBI.util.EventProvider);
...
(function () {
    ...
    * @constructor
    */
    HBI.widget.Overlay = function (el, userConfig) {
        HBI.widget.Overlay.superclass.constructor.call(this, el, userConfig);
    };
    ...
    * @property HBI.widget.Overlay.IFRAME_SRC
    * @static
    * @final
    * @type String
    */
    ...
    * @property HBI.widget.Overlay.VIEWPORT_OFFSET
    * @default 10
    * @static
    * @final
    * @type Number
    ...
    * @property HBI.widget.Overlay.TOP_LEFT
    * @static
    * @final
    * @type String
    */
    ...
    * configuring the context element alignment
    * @property HBI.widget.Overlay.TOP_RIGHT
    * @static
    * @final
    * @type String
    */
    ...
    * configuring the context element alignment
    * @property HBI.widget.Overlay.BOTTOM_LEFT
    * @static
    * @final
    * @type String
    */
    ...
    * configuring the context element alignment
    * @property HBI.widget.Overlay.BOTTOM_RIGHT
    * @static
    * @final
    * @type String
    */
    ...
    * @property HBI.widget.Overlay.CSS_OVERLAY
    * @static
    * @final
    * @type String
    */
    ...
    *
    * @property HBI.widget.Overlay.CSS_HIDDEN
    * @static
    * @final
    * @type String
    */
    ...
    * 
    * @property HBI.widget.Overlay.CSS_IFRAME
    * @static
    * @final
    * @type String
    */
     ...
     * used in the overlay.
     * @property HBI.widget.Overlay.STD_MOD_RE
     * @static
     * @final
     * @type RegExp
     */
    ...
    * window scroll
    * @event HBI.widget.Overlay.windowScrollEvent
    */
    ...
    * A singleton CustomEvent used for reacting to the DOM event for
    * window resize
    * @event HBI.widget.Overlay.windowResizeEvent
    */
    Overlay.windowResizeEvent = new CustomEvent("windowResize");

    /**
    * The DOM event handler used to fire the CustomEvent for window scroll
    * @method HBI.widget.Overlay.windowScrollHandler
    * @static
    ...
    * @method HBI.widget.Overlay.windowResizeHandler
    * @static
    * @param {DOMEvent} e The DOM resize event
    */
    ...
    * @property HBI.widget.Overlay._initialized
    * @private
    * @type Boolean
    */
     ...
     *
     * @property HBI.widget.Overlay._TRIGGER_MAP
     * @type Object
     * @static
     * @private
     */
    ...
    HBI.extend(Overlay, Module, {
         ...
         * <p>
         * E.g.:
         * <code>CustomOverlay.prototype.CONTEXT_TRIGGERS = HBI.widget.Overlay.prototype.CONTEXT_TRIGGERS.concat(["windowScroll"]);</code>
         * </p>
         * 
        ...
        */
        ...
        stackIframe: function () {
            if (this.iframe) {
                ...
                if (!HBI.lang.isUndefined(overlayZ) && !isNaN(overlayZ)) {
        ...
        */
        ...
        _primeXYFromDOM : function() {
            if (HBI.lang.isUndefined(this.cfg.getProperty("xy"))) {
...
(function () {
    ...
    */
    HBI.widget.OverlayManager = function (userConfig) {
        this.init(userConfig);
    };

    var Overlay = HBI.widget.Overlay,
        Event = HBI.util.Event,
        Dom = HBI.util.Dom,
        Config = HBI.util.Config,
        CustomEvent = HBI.util.CustomEvent,
        OverlayManager = HBI.widget.OverlayManager;
    ...
    */
    ...
    OverlayManager.prototype = {
        ...
        * Overlay instances.
        * @method bringToTop
        * @param {HBI.widget.Overlay} p_oOverlay Object representing an 
        * Overlay instance.
...
(function () {
    ...
    * documentation for more details.
    */
    HBI.widget.Tooltip = function (el, userConfig) {
        HBI.widget.Tooltip.superclass.constructor.call(this, el, userConfig);
    };
    ...
    * @property HBI.widget.Tooltip.CSS_TOOLTIP
    * @static
    * @final
    * @type String
    */
    ...
    */
    ...
    HBI.extend(Tooltip, HBI.widget.Overlay, { 
        ...
        */
        doShow: function (e, context) {
            ...
            return setTimeout(function () {
                ...
                if (me._tempTitle && (txt === "" || HBI.lang.isUndefined(txt) || HBI.lang.isNull(txt))) {
        ...
        */
        preventOverlap: function (pageX, pageY) {
            ...
            var height = this.element.offsetHeight,
                mousePoint = new HBI.util.Point(pageX, pageY),
...
(function () {
    ...
    * documentation for more details.
    */
    HBI.widget.Panel = function (el, userConfig) {
        HBI.widget.Panel.superclass.constructor.call(this, el, userConfig);
    };
    ...
    var Lang = HBI.lang,
        ...
        KeyListener = HBI.util.KeyListener,
        Config = Util.Config,
        Overlay = HBI.widget.Overlay,
        Panel = HBI.widget.Panel,
        UA = HBI.env.ua,
    ...
    * @property HBI.widget.Panel.CSS_PANEL
    * @static
    * @final
    * @type String
    */
    ...
    * wrapping container
    * @property HBI.widget.Panel.CSS_PANEL_CONTAINER
    * @static
    * @final
    * @type String
    */
     ...
     * 
     * @property HBI.widget.Panel.FOCUSABLE
     * @static
     * @type Array
     */
    Panel.FOCUSABLE = [
    ...
    HBI.extend(Panel, Overlay, {
        ...
        configUnderlay: function (type, args, obj) {
            ...
            function createUnderlay() {
                ...
                if (!oUnderlay) { // create if not already in DOM
                    ...
                    if (bIEQuirks) {
                        ...
                        HBI.widget.Module.textResizeEvent.subscribe(this.sizeUnderlay, this, true);
                    }
            ...
            function destroyUnderlay() {
                ...
                if (oUnderlay) {
                    ...
                    HBI.widget.Module.textResizeEvent.unsubscribe(this.sizeUnderlay, this, true);
        ...
        */
        registerDragDrop: function () {
            ...
            if (this.header) {
                ...
                /**
                 * The HBI.util.DD instance, used to implement the draggable header for the panel if draggable is enabled
                 *
                 * @property dd
                 * @type HBI.util.DD
                 */
                ...
                this.dd.onDrag = function () {
                    me.syncPosition();
                    me.cfg.refireEvent("iframe");
                    if (this.platform == "mac" && HBI.env.ua.gecko) {
                        this.showMacGeckoScrollbars();
                    }
        ...
        */
        buildMask: function () {
            ...
            if (!oMask) {
                ...
                if (HBI.env.ua.gecko && this.platform == "mac") {
        ...
        */
        ...
        stackMask: function() {
            if (this.mask) {
                var panelZ = Dom.getStyle(this.element, "zIndex");
                if (!HBI.lang.isUndefined(panelZ) && !isNaN(panelZ)) {
...
(function () {
    ...
    * created will be instances of HBI.widget.Button, otherwise regular HTML buttons
    * will be created.
    * </p>
    * <p>
    ...
    * documentation for more details.
    */
    HBI.widget.Dialog = function (el, userConfig) {
        HBI.widget.Dialog.superclass.constructor.call(this, el, userConfig);
    };

    var Event = HBI.util.Event,
        CustomEvent = HBI.util.CustomEvent,
        Dom = HBI.util.Dom,
        Dialog = HBI.widget.Dialog,
        Lang = HBI.lang,
    ...
    * @property HBI.widget.Dialog.CSS_DIALOG
    * @static
    * @final
    * @type String
    */
        ...
        if (Lang.isArray(aButtons)) {
            ...
            if (nButtons > 0) {
                ...
                do {
                    ...
                    if (HBI.widget.Button && oButton instanceof HBI.widget.Button) {
                        oButton.destroy();
                    }
    ...
    HBI.extend(Dialog, HBI.widget.Panel, { 
        ...
        initDefaultConfig: function () {
            ...
            */
            this.callback = {
                ...
                * </p>
                * <p>
                * For more information, see the <a href="http://developer.HBI.com/yui/connection/#file">
            ...
            * <a href="HBI.util.Connect.html#method_asyncRequest">asyncRequest</a> 
            * method.
            * @config postdata
            * @type String
            * @default null
            ...
            * the buttons created will be instances of HBI.widget.Button. 
        ...
        */
        initEvents: function () {
            ...
            * @param {Object} conn The connection object, returned by HBI.util.Connect.asyncRequest
            */
        ...
        * information, see the <a href="http://developer.HBI.com/yui/
        * connection/#file">Connection Manager documenation on file uploads</a>.
        * @method doSubmit
        */
        doSubmit: function () {

            var Connect = HBI.util.Connect,
                oForm = this.form,
            ...
            switch (this.cfg.getProperty("postmethod")) {
                ...
                case "async":
                    ...
                    if (bUseFileUpload && HBI.env.ua.ie && this.isSecure) {
        ...
        * HBI.widget.Button class (via the inclusion of the optional Button 
        * dependancy on the page), an array of HBI.widget.Button instances 
        * is returned.
        * @return {Array}
        */
        getButtons: function () {
        ...
        */
         ...
         * reference is not found or HBI.widget.Button does not exist on the page.
         *
         * @method _getButton
         * @private
         * @param {HTMLElement} button
         * @return {HBI.widget.Button|HTMLElement}
         */
...
(function () {
    ...
    */
    HBI.widget.SimpleDialog = function (el, userConfig) {
    
        HBI.widget.SimpleDialog.superclass.constructor.call(this, 
            el, userConfig);
    
    };

    var Dom = HBI.util.Dom,
        SimpleDialog = HBI.widget.SimpleDialog,
    ...
    * @property HBI.widget.SimpleDialog.ICON_BLOCK
    * @static
    * @final
    * @type String
    */
    ...
    * @property HBI.widget.SimpleDialog.ICON_ALARM
    * @static
    * @final
    * @type String
    */
    ...
    * @property HBI.widget.SimpleDialog.ICON_HELP
    * @static
    * @final
    * @type String
    */
    ...
    * @property HBI.widget.SimpleDialog.ICON_INFO
    * @static
    * @final
    * @type String
    */
    ...
    * @property HBI.widget.SimpleDialog.ICON_WARN
    * @static
    * @final
    * @type String
    */
    ...
    * @property HBI.widget.SimpleDialog.ICON_TIP
    * @static
    * @final
    * @type String
    */
    ...
    * @property HBI.widget.SimpleDialog.ICON_CSS_CLASSNAME
    * @static
    * @final
    * @type String
    */
    ...
    * @property HBI.widget.SimpleDialog.CSS_SIMPLEDIALOG
    * @static
    * @final
    * @type String
    */
    ...
    HBI.extend(SimpleDialog, HBI.widget.Dialog, {
...
(function () {
    ...
    * @constructor
    * @param {HBI.widget.Overlay} overlay The Overlay that the animation 
    * should be associated with
    * @param {Object} attrIn The object literal representing the animation 
    * arguments to be used for the animate-in transition. The arguments for 
    * this literal are: attributes(object, see HBI.util.Anim for description), 
    ...
    * HBI.util.Anim. Other options include HBI.util.Motion.
    */
    HBI.widget.ContainerEffect = function (overlay, attrIn, attrOut, targetElement, animClass) {

        if (!animClass) {
            animClass = HBI.util.Anim;
        }
    ...
    var Dom = HBI.util.Dom,
        CustomEvent = HBI.util.CustomEvent,
        ContainerEffect = HBI.widget.ContainerEffect;
    ...
    * @method FADE
    * @static
    * @param {HBI.widget.Overlay} overlay The Overlay object to animate
    * @param {Number} dur The duration of the animation
    * @return {HBI.widget.ContainerEffect} The configured ContainerEffect object
    */
    ContainerEffect.FADE = function (overlay, dur) {

        var Easing = HBI.util.Easing,
            fin = {
    ...
    */
    ContainerEffect.SLIDE = function (overlay, dur) {
        var Easing = HBI.util.Easing,
            ...
            slide = new ContainerEffect(overlay, sin, sout, overlay.element, HBI.util.Motion);
    ...
    HBI.lang.augmentProto(ContainerEffect, HBI.util.EventProvider);

})();
HBI.register("container", HBI.widget.Module, {version: "2.8.0r4", build: "2449"});
