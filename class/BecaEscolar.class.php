...
class BecaEscolar extends Conexion {
    ...
    public function insert_BecaEscolar() {
        try {
            ...
            $sql = "INSERT INTO beca_escolar VALUES(:id_beca,:id_tipo_beca,:id_frecuencia_beca,:id_registro_alumno,:porcentaje_beca,:fecha_inicio_beca,:fecha_fin_beca,:activo)";
    ...
    public function update_BecaEscolar($arrayWhere) {
        try {
            ...
            $sql = "UPDATE beca_escolar SET id_beca=:id_beca,id_tipo_beca=:id_tipo_beca,id_frecuencia_beca=:id_frecuencia_beca,id_registro_alumno=:id_registro_alumno,porcentaje_beca=:porcentaje_beca,fecha_inicio_beca=:fecha_inicio_beca,fecha_fin_beca=:fecha_fin_beca,activo=:activo WHERE $where";
            $resultSet = $this->conection->prepare($sql);
            foreach ($arrayWhere as $key => $value):
