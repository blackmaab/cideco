...
class RegistroAlumno extends Conexion {
    ...
    public function insert_RegistroAlumno() {
        try {
            ...
            $sql = "INSERT INTO registro_alumno VALUES(:id_registro,:anio,:id_alumno,:id_institucion_edu,:id_grado,:seccion,:nota_promedio,:fecha_creacion,:activa)";
            ...
            $resultSet->bindParam(":activa", $this->activa);
            $resultSet->execute();
