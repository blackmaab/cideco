...
class Donacion extends Conexion {
    ...
    public function insert_Donacion() {
        try {
            ...
            $sql = "INSERT INTO donacion VALUES(:id_donacion,:anio,:id_donante,:id_tipo_pago,:id_promotor,:id_registro_alumno,:Monto,:mes_inicio,:fecha_creacion,:estado)";
            $resultSet = $this->conection->prepare($sql);
            $resultSet->bindParam(":id_donacion", $this->id_donacion);
            $resultSet->bindParam(":anio", $this->anio);
            ...
            $resultSet->bindParam(":mes_inicio", $this->mes_inicio);
