...
function SaveData()
{
	...
	try
	{
		...
		if(CheckParam())
		{
			...
			parameters = parameters + "&p6=" + combo_perfil.getActualValue();
			parameters = parameters + "&p7=" + combo_status.getActualValue();
...
function init() {
	...
	try
	{
		...
		FormRegistro = new HBI.widget.Dialog("RegNew", { width : "60em", fixedcenter : true, visible : false, modal: true, constraintoviewport : true, 
