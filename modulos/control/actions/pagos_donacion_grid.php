...
*/
	...
	$head .="<head>";
		...
		$head .="<column width='100' type='ro' align='center' sort='str'>No. Donacion</column> \n";
		$head .="<column width='100' type='ro' align='left' sort='str'>Nombre Donante</column> \n";
		...
		$head .="<column width='300' type='ro' align='left' sort='str'>Alumno</column> \n";
		$head .="<column width='100' type='ro' align='left' sort='str'>Centro Escolar</column> \n";
		$head .="<column width='100' type='ro' align='left' sort='str'></column> \n";
