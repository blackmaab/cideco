...
function doOnLoad() {
    ...
    toolbar.loadXML("../../../components/toolbar/Mantenimiento_estado_donante.xml?etc=" + new Date().getTime());
...
function LoadGrid()
{
    ...
    mygrid.loadXML("../actions/estado_donante_grid.php",
        function()
        {
    ...
    try
    {
        ...
        if(CheckParam())
        {
            ...
            if (idReg==0)
            {
                ...
                loader = dhtmlxAjax.post( "../actions/estado_donante_insert.php",encodeURI(parameters), function(){
                    ReadXml()
                } );
            }
            else
            {
                ...
                parameters+="&p2="+idReg;                
                loader = dhtmlxAjax.post( "../actions/estado_donante_update.php",encodeURI(parameters), function(){
                    ReadXml()
                } );
            }
...
function DeleteData()
{
    ...
    if (idReg>0)
    {
        loader = dhtmlxAjax.post( "../actions/estado_donante_delete.php",encodeURI(parameters), function(){
            ReadXml()
        } );
    }
