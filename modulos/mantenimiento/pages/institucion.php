...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en" lang="en-AU">
    ...
    <body class="yui-skin-sam" onLoad="init();LoadData();doOnLoad();doCalendar();" >
        ...
        <fieldset style="width: 99%;">
            <legend class="fieldsetTitle">&nbsp;Mantenimiento - Institucion Educativa</legend>
                    ...
                    <div class="label">
                        ...
                        <table width="100%" >
                            ...
                            <tr>
                                ...
                                <td ><input name="txtNombre" id="txtNombre" class="medium" onfocus="jform.col(this);" /></td>
                            </tr>		
                            <tr>
                                <td  align="center"></td>
                                <td >Direccion:</td>
                                <td rowspan="2"><textarea name="txtDireccion" id="txtDireccion" 
                                                          style="height:70px;width: 250px;padding: 3px 3px 3px 3px;border: 1px solid #ddd ;background: #ffffff;;font-size: 11px;color: #000000;overflow: auto;"></textarea>
                                </td>
                            </tr>
                            <tr><td></td><td>&nbsp;</td></tr>	
                            <tr>
                                <td  align="center"><div class="fieldsetTitle"></div></td>
                                <td >Telefono: <br/>(Formato: [2|7|6] 000-0000)</td>
                                <td ><input name="txtTelefono" id="txtTelefono" class="tiny" onfocus="jform.col(this);" /></td>
                            </tr>		
                            <tr>
                                <td  align="center"></td>
                                <td >Nombre Director:</td>
                                <td ><input name="txtDirector" id="txtDirector" class="medium" onfocus="jform.col(this);" /></td>
                            </tr>				
