...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en" lang="en-AU">
    ...
    <body class="yui-skin-sam" onLoad="init();LoadData();doOnLoad();" >
        ...
        <fieldset style="width: 99%;">
            <legend class="fieldsetTitle">&nbsp;Mantenimiento - Grado Escolar</legend>
                    ...
                    <div class="label">
                        ...
                        <table width="100%" >
                            ...
                            <tr>
                                ...
                                <td >Descripcion del Grado:</td>
                                <td ><input name="txtGrado" id="txtGrado" class="medium" onfocus="jform.col(this);" /></td>
                            </tr>				
                            <tr>
                                <td  align="center"><div class="fieldsetTitle">*</div></td>
                                <td>Activo:</td>
