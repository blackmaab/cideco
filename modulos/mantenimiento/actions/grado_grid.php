...
/**
 * Nombre de Archivo: grado_grid.php
...
$head .="<column width='150' type='ro' align='left' sort='str'>Grado</column> \n";
...
$contador = 0;
$retVal = "";
$array_data = $obj_grado->select_Grado();

foreach ($array_data as $key => $value):
    $retVal .= "<row id='$contador'> \n";
    $retVal .= "<cell >" . $value["id_grado"] . "</cell> \n";
